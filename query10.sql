with stops_with_geog as (
    select
        ...
        rs.stop_lat,
        st_setsrid(
            st_makepoint(rs.stop_lon, rs.stop_lat), 4326
...
cross join
    lateral (
        ...
        order by stops.stops_geog <-> p.geog
        limit 1
    ) as parcels
